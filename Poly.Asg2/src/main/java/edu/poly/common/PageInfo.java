...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.SITE_CHANGE_PASSWPORD_PAGE, new PageInfo("Change Password","/sites/users/change-password.jsp", null));
		pageRoute.put(PageType.SITE_EDIT_PROFILE_PAGE, new PageInfo("Edit Profile","/sites/users/edit-profile.jsp", null));
		pageRoute.put(PageType.SITE_FORGOT_PASSWPORD_PAGE, new PageInfo("Forgot Password","/sites/users/forgot-password.jsp", null));
		...
		pageRoute.put(PageType.SITE_TEST_PAGE, new PageInfo("Test","/admin/videos/test.jsp", null));
